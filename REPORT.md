...
Пока что в Verilog наблюдаются проблемы с отображением регистров снаружи схемы — данные зануляются.  
...
Если отает можно посчитать сразу же, например +-INF, NAN, Zero, то после первого спада ответ выведется на входовых и всё
